...
- 🔎  I regularly write about programming on [dev.to](https://dev.to/derkiner) , [freeCodeCamp](https://www.freecodecamp.org/news/author/damla/) and [Medium](https://medium.com/@Phoenix_Skywalker) as it's an excellent way to keep learning & staying up-to-date.  I'm currently in the process of creating tutorials for fellow programmers around the world. 
