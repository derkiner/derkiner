...
- 🔎  I regularly write on programming. You may read my technical articles on [my Medium account](https://medium.com/@Phoenix_Skywalker). Recently, I've also been accepted as a tech content author by freeCodeCamp and I'm currently in the process of creating tutorials for fellow programmers around the world. The technical tutorials & articles I create there can be found on [my freeCodeCamp blog page](https://www.freecodecamp.org/news/author/damla/).
